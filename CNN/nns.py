...
class LeNetConvPoolLayer(object):
    ...
    def __init__(self, rng, input, filter_shape, image_shape, border_mode='valid',pool_enabled=True, poolsize=(2, 2)):
        """
...
def train_nn(fil,train_model, validate_model, test_model,
            n_train_batches, n_valid_batches, n_test_batches, n_epochs,
            pic_out=False, verbose = True):
    """
    ...
    while (epoch < n_epochs) and (not done_looping):
        ...
        for minibatch_index in range(n_train_batches):
            ...
            if (iter % 1000 == 0) and verbose:
                ...
                print('training @ iter = %i'%iter,file=f)
            ...
            if (iter + 1) % validation_frequency == 0:
                ...
                if verbose:
                    print('epoch %i, minibatch %i/%i, validation error %f %%' %
                        (epoch, minibatch_index + 1, n_train_batches, this_validation_loss * 100.),file=f)
                    print('epoch %i, minibatch %i/%i, validation error %f %%' %
