...
def test_mlp(n_hidden, n_layers,learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=500,
    ...
    #n_layers = input("Enter the number of hidden layer you want, maximum is 7: ")
    ...
    print('Number of hidden layers is :%i. ' %n_layers,file = f)
    print('Number of neurons is :%i. ' %n_hidden,file = f)
    
    print('... training')
    print('Number of hidden layers is :%i. ' %n_layers)
    print('Number of neurons is :%i. ' %n_hidden)
...
if __name__ == '__main__':
    test_mlp(n_hidden=500,n_layers=2)